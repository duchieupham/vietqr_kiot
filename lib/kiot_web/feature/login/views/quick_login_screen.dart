...
class QuickLoginScreenWeb extends StatefulWidget {
  ...
  @override
  State<QuickLoginScreenWeb> createState() => _QuickLoginScreenState();
}

class _QuickLoginScreenState extends State<QuickLoginScreenWeb> {
        ...
        child: Column(
          children: [
            ...
            MButtonWidget(
              ...
              colorEnableText:
                  isButtonLogin ? AppColor.WHITE : AppColor.GREY_TEXT,
              onTap: () {
                AccountLoginDTO dto = AccountLoginDTO(
                  phoneNo: widget.phone,
                  password: EncryptUtils.instance.encrypted(
